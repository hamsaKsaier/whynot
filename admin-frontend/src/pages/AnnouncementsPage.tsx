        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="divide-y divide-gray-200">
            {loading ? (
              ...
              <tr><td colSpan={5} className="px-4 py-8 text-center text-gray-400">No announcements</td></tr>
              ...
              <tr key={a.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">
                  <span className={`h-2 w-2 rounded-full inline-block ${a.is_active ? 'bg-green-500' : 'bg-gray-300'}`} />
                </td>
                ...
                <td className="px-4 py-3 text-right">
                  ...
                  <button onClick={() => handleDelete(a.id)} className="p-1.5 hover:bg-red-50 rounded-lg text-red-500 ml-1" title="Delete">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-lg mx-4">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
              ...
              <button onClick={() => setShowModal(false)} className="p-1 hover:bg-gray-100 rounded"><FiX className="h-4 w-4" /></button>
            </div>
