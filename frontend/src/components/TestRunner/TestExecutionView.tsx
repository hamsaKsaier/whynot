    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden hidden md:flex relative">
          ...
          {!headless && (
            <div className={`w-full ${showBrowserPreview ? 'lg:w-1/2' : 'lg:w-0'} flex-shrink-0 border-l border-gray-200 min-w-0 transition-all duration-300 hidden lg:block`}>
          ...
          {!headless && showBrowserPreview && (
            <div className="hidden md:block lg:hidden w-full border-t border-gray-200">
              {renderPreviewPane()}
            </div>
          )}
        </div>
        ...
        <div className="md:hidden flex-1 overflow-hidden">
          {activeTab === 'steps' && (
            <div className="h-full overflow-y-auto border-b border-gray-200">
              {renderStepsPane()}
            </div>
          )}
          {activeTab === 'details' && (
        ...
        <div className={`hidden md:block border-t border-gray-200 transition-all duration-300 ${isAgentPanelCollapsed ? 'h-12' : 'h-64'}`}>
          <div className="flex items-center justify-between px-4 py-2 bg-gray-50 border-b border-gray-200">
            <h3 className="font-semibold text-gray-900 text-sm">Agent Activity</h3>
            <button
