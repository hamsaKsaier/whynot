...
color: "#E91E63"
tools:
  mock_driven_development: true
  outside_in_tdd: true
  behavior_verification: true
  swarm_test_coordination: true
...
This agent was bridged from `.claude/agents/testing/unit/tdd-london-swarm.md` during the Claude → OpenCode migration.
