...
This agent was bridged from `.claude/agents/marketing/marketing-baidu-seo-specialist.md` during the Claude → OpenCode migration.
...
- **细雨算法 (raw SQL in shared/database/repositories/)**: B2B and Yellow Pages site optimization; avoid keyword stuffing in titles
